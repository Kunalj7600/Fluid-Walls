...
class NatureWallpapers extends StatefulWidget {
  const NatureWallpapers({super.key});

  @override
  State<NatureWallpapers> createState() => _NatureWallpapersState();
}

class _NatureWallpapersState extends State<NatureWallpapers> {
  ...
  void initState() {
    ...
    imagesList = repo.getImagesBySearch(query: "nature", pageNumber: pageNumber);
    super.initState();
  }
